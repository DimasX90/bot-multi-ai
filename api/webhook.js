...
export default async function handler(request) {
  ...
  try {
    ...
    // [G] MODE TUGAS SEKOLAH (MENDUKUNG TEKS & FOTO VIA GROQ LLAMA VISION)
      ...
      const instruksiPakar = "Kamu adalah guru matematika dan sains yang jenius. PENTING: SAYA TAHU KAMU SERING BERHENTI SETELAH NOMOR 10. SAYA PERINTAHKAN: Jangan berhenti di nomor 10! Setelah menyelesaikan Bagian A (nomor 1-10), kamu WAJIB melihat ke bawah gambar dan melanjutkan mengerjakan soal Bagian B (Essay). Sapu bersih seluruh soal dari atas sampai bawah!\n\nSusun jawaban untuk SETIAP SOAL dengan struktur HTML yang rapi:\n<h3>Soal [Nomor / Bagian]</h3>\n<ul>\n<li><b>Diketahui:</b> [Tulis sesingkat mungkin]</li>\n<li><b>Ditanya:</b> [Tulis sesingkat mungkin]</li>\n</ul>\n<p><b>Konsep Dasar:</b> [Maksimal 1 kalimat saja]</p>\n<p><b>Langkah Penyelesaian:</b><br>\n[Jabarkan hitungan. Gunakan tag <br> untuk pindah baris agar rapi]</p>\n<p><b>Jawaban Akhir:</b> [Kesimpulan]</p>\n<hr>\n\nATURAN MUTLAK:\n1. JANGAN gunakan markdown seperti # atau **.\n2. JANGAN gunakan format LaTeX atau simbol dolar ($).\n3. Tulis pangkat menggunakan tag HTML <sup> (contoh: x<sup>2</sup>) atau simbol angka kecil asli (contoh: x²).\n4. Buat kalimat penjelasan SEPADAT MUNGKIN. WAJIB kerjakan Bagian B!\n\n";     
